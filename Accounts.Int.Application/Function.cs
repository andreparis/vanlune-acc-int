...
using System.Net;
using Accounts.Int.Application.Extensions;
using Accounts.Int.Application.Application.MediatR.Commands.User.AuthenticateUser;
using Accounts.Int.Application.Application.MediatR.Commands.User.GoogleValidUser;

[assembly: LambdaSerializer(typeof(Amazon.Lambda.Serialization.Json.JsonSerializer))]
namespace Accounts.Int.Application
{
    public class Function
    {
        ...
        public APIGatewayProxyResponse AuthenticateAccount(APIGatewayProxyRequest request, ILambdaContext lambdaContext)
        {
            ...
            return Request<FacebookValidUserCommand>(request.Body);
        }

        public APIGatewayProxyResponse AuthenticateAccountGoogle(APIGatewayProxyRequest request, ILambdaContext lambdaContext)
        {
            lambdaContext.Logger.LogLine($"Body {request.Body}");

            return Request<GoogleValidUserCommand>(request.Body);
        }
